...
$student_data = $con->getsStudentByID($student_id); 
$sweetAlertConfig = "";
    ...
    if (isset($_POST['save'])){
      ...
      $update_status = $con->updateStudent($firstname, $lastname, $email, $student_id);
  ...
  <div class="container py-5">
    ...
    <form method="POST" action="" class="bg-white p-4 rounded shadow-sm">
      ...
      <label for="student_id" class="form-label">Student ID</label>
        <input type="text" name="student_id" id="student_id" value="<?php echo $student_data ['student_id']?>"  id="student_id" class="form-control"
        disabled required>
      </div>
